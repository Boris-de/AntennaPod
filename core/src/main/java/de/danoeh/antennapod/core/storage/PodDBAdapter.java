...
public class PodDBAdapter {
    ...
    private static final String CREATE_TABLE_FEEDS = "CREATE TABLE "
            ...
            + KEY_PLAYBACK_SPEED + " DECIMAL(5,2) DEFAULT NULL)";
    ...
    public void setFeedPreferences(FeedPreferences prefs) {
        ...
        values.put(KEY_PLAYBACK_SPEED, prefs.getPlaybackSpeed().getSpeedForPrefs());
    ...
    private static class PodDBHelper extends SQLiteOpenHelper {
        ...
        private static final int VERSION = 1060600;
